...
static const ERROR TTO_WORDS_VALUELESS_FAIL            = 900;
static const ERROR TTO_UNKNOWN_TYPE_FAIL               = 901;
static const ERROR TTO_NOT_IMPLEMENTED_FAIL            = 902;
static const ERROR TTO_STRING_ESCAPE_FAIL              = 903;
static const ERROR TTO_ESCAPE_END_FAIL                 = 904;
static const ERROR TTO_MALLOC_FAIL                     = 905;
static const ERROR TTO_ESCAPE_BAD_HEX_FAIL             = 906;
static const ERROR TTO_OUT_OF_RANGE_FAIL               = 907;
static const ERROR TTO_INVALID_BASE_FAIL               = 908;
static const ERROR TTO_INVALID_DIGIT_FAIL              = 909;
static const ERROR TTO_FLP_CONVERT_FAIL                = 910;
