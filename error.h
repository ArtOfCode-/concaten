...
//extern const ERROR    CTOR_STR_FAIL;              //    8110
  extern const ERROR     CTOR_STR_MALLOC_FAIL;      //     8111
  extern const ERROR     CTOR_STR_BAD_STRLEN_FAIL;  //     8112
  extern const ERROR     CTOR_STR_NULL_ARG_FAIL;    //     8113
//extern const ERROR    CTOR_FILE_FAIL;             //    8120
  extern const ERROR     CTOR_FILE_MALLOC_FAIL;     //     8121
  extern const ERROR     CTOR_FILE_BAD_STRLEN_FAIL; //     8122
  extern const ERROR     CTOR_FILE_NULL_ARG_FAIL;   //     8123
  extern const ERROR     CTOR_FILE_FOPEN_FAIL;      //     8124
//extern const ERROR   READ_CHAR_FAIL;              //   8200
  extern const ERROR    FILE_READ_FAIL;             //    8210
  extern const ERROR     FILE_READ_EOF_FAIL;        //     8211
//extern const ERROR    STRING_READ_FAIL;           //    8220
  extern const ERROR     STRING_READ_EOS_FAIL;      //     8221
//extern const ERROR   NEXT_TOKEN_FAIL;             //   8300
  extern const ERROR    NT_MALLOC_FAIL;             //    8301
  extern const ERROR    NT_NEW_SB_FAIL;             //    8302
  extern const ERROR    NT_SB_FREE_COPY_FAIL;       //    8303
  extern const ERROR    NT_INPUT_END_FAIL;          //    8304
//extern const ERROR  TOKENIZER_SYNTAX_FAIL;        //  8500
  extern const ERROR   SYN_NO_SEPARATION_FAIL;      //   8501
  extern const ERROR   SYN_UNEXPECTED_END_FAIL;     //   8502
//extern const ERROR   SYN_STR_FAIL;                //   8510
  extern const ERROR    SYN_STR_MULTILINE_FAIL;     //    8511
//extern const ERROR   SYN_NUM_FAIL;                //   8520
  extern const ERROR    SYN_NUM_ILLEGAL_DIGIT_FAIL; //    8521
//extern const ERROR   SYN_RGX_FAIL;                //   8530
  extern const ERROR    SYN_RGX_BAD_FLAG_FAIL;      //    8531
